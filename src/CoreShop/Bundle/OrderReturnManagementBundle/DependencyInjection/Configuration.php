...
namespace CoreShop\Bundle\OrderReturnManagementBundle\DependencyInjection;

use CoreShop\Bundle\OrderReturnManagementBundle\Controller\OrderReturnController;
use CoreShop\Bundle\OrderReturnManagementBundle\Pimcore\Repository\OrderReturnRepository;
use CoreShop\Bundle\ResourceBundle\CoreShopResourceBundle;
use CoreShop\Component\Resource\Factory\PimcoreFactory;
use CoreShop\Component\OrderReturnManagement\Model\OrderReturnInterface;
use CoreShop\Component\OrderReturnManagement\Model\OrderReturnItemInterface;
...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('core_shop_order_return_management');
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('install_file')->defaultValue('@CoreShopOrderReturnManagementBundle/Resources/install/pimcore/classes/CoreShopOrderReturn.json')->end()
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('install_file')->defaultValue('@CoreShopOrderReturnManagementBundle/Resources/install/pimcore/classes/CoreShopOrderReturnItem.json')->end()
                                        ->scalarNode('type')->defaultValue(CoreShopResourceBundle::PIMCORE_MODEL_TYPE_OBJECT)->cannotBeOverwritten(true)->end()
                                    ->end()
                                ->end()
                            ->end()
