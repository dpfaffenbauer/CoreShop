CoreShop Pessimistic Entity Lock Bundle
==================
...
Documentation is available on [**coreshop.org**](https://docs.coreshop.org/2.1.0/Bundles/OptimisticEntityLock_Bundle.html).
