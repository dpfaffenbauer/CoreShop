...
abstract class OrderReturn extends AbstractPimcoreModel implements OrderReturnInterface
{
    ...
    {
        return 'CoreShop\Bundle\OrderReturnManagementBundle\Controller\OrderDocumentPrintController::returnAction';
    }

    public function getPrintHeaderController(array $params = []): string
    {
        return 'CoreShop\Bundle\OrderReturnManagementBundle\Controller\OrderDocumentPrintController::headerAction';
    }

    public function getPrintFooterController(array $params = []): string
    {
        return 'CoreShop\Bundle\OrderReturnManagementBundle\Controller\OrderDocumentPrintController::footerAction';
    }
